        ...
        <div class="container join-hero__container">
            <div class="join-hero__top">
                <?php if (!empty($hero_title)): ?>
                    <h1 class="join-hero__title"><?= esc_html($hero_title); ?></h1>
                <?php endif; ?>
                <?php if (!empty($hero_subtitle)): ?>
                    <p class="join-hero__subtitle"><?= esc_html($hero_subtitle); ?></p>
                <?php endif; ?>
            </div>
            <div class="join-hero__bottom">
                <?php if (!empty($hero_tagline)): ?>
                    <div class="join-hero__tagline"><?= wp_kses_post($hero_tagline); ?></div>
                <?php endif; ?>
