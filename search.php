...
<section class="for_sale">
    <div class="container">
            ...
            <div class="filter">
                ...
                <div class="filter-options">
                    <?php if (!empty($bedrooms)): ?>
                        <a data-attr="property_type" href="<?php echo esc_url(home_url('/')); ?>?s=<?php echo $s ?>&bedrooms=<?php echo $bedrooms; ?>&property_type=detached<?php echo $more_properties; ?>" class="filter-button prop <?php echo $property_type == 'detached' ? 'active' : ''; ?>" data-option="detached">Detached</a>
                        <a data-attr="property_type" href="<?php echo esc_url(home_url('/')); ?>?s=<?php echo $s ?>&bedrooms=<?php echo $bedrooms; ?>&property_type=semi-detached<?php echo $more_properties; ?>" class="filter-button prop <?php echo $property_type == 'semi-detached' ? 'active' : ''; ?>" data-option="semi-detached">Semi-detached</a>
                        <a data-attr="property_type" href="<?php echo esc_url(home_url('/')); ?>?s=<?php echo $s ?>&bedrooms=<?php echo $bedrooms; ?>&property_type=terraced<?php echo $more_properties; ?>" class="filter-button prop <?php echo $property_type == 'terraced' ? 'active' : ''; ?>" data-option="terraced">Terraced</a>
                        <a data-attr="property_type" href="<?php echo esc_url(home_url('/')); ?>?s=<?php echo $s ?>&bedrooms=<?php echo $bedrooms; ?>&property_type=end-of-terrace<?php echo $more_properties; ?>" class="filter-button prop <?php echo $property_type == 'end-of-terrace' ? 'active' : ''; ?>" data-option="end-of-terrace">End of Terrace</a>
                        <a data-attr="property_type" href="<?php echo esc_url(home_url('/')); ?>?s=<?php echo $s ?>&bedrooms=<?php echo $bedrooms; ?>&property_type=flat<?php echo $more_properties; ?>" class="filter-button prop <?php echo $property_type == 'flat' ? 'active' : ''; ?>" data-option="flat">Flat</a>
                    <?php else: ?>
                        <a data-attr="property_type" href="<?php echo esc_url(home_url('/')); ?>?s=<?php echo $s ?>&property_type=detached<?php echo $more_properties; ?>" class="filter-button prop <?php echo $property_type == 'detached' ? 'active' : ''; ?>" data-option="detached">Detached</a>
                        <a data-attr="property_type" href="<?php echo esc_url(home_url('/')); ?>?s=<?php echo $s ?>&property_type=semi-detached<?php echo $more_properties; ?>" class="filter-button prop <?php echo $property_type == 'semi-detached' ? 'active' : ''; ?>" data-option="semi-detached">Semi-detached</a>
                        <a data-attr="property_type" href="<?php echo esc_url(home_url('/')); ?>?s=<?php echo $s ?>&property_type=terraced<?php echo $more_properties; ?>" class="filter-button prop <?php echo $property_type == 'terraced' ? 'active' : ''; ?>" data-option="terraced">Terraced</a>
                        <a data-attr="property_type" href="<?php echo esc_url(home_url('/')); ?>?s=<?php echo $s ?>&property_type=end-of-terrace<?php echo $more_properties; ?>" class="filter-button prop <?php echo $property_type == 'end-of-terrace' ? 'active' : ''; ?>" data-option="end-of-terrace">End of Terrace</a>
                        <a data-attr="property_type" href="<?php echo esc_url(home_url('/')); ?>?s=<?php echo $s ?>&property_type=flat<?php echo $more_properties; ?>" class="filter-button prop <?php echo $property_type == 'flat' ? 'active' : ''; ?>" data-option="flat">Flat</a>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="filter">
                ...
                <div class="filter-options">
                    <?php if (!empty($property_type)): ?>
                        <a data-attr="bedrooms" href="<?php echo esc_url(home_url('/')); ?>?s=<?php echo $s ?>&property_type=<?php echo $property_type; ?>&bedrooms=1-2<?php echo $more_properties; ?>" class="filter-button bedr <?php echo $bedrooms == '1-2' ? 'active' : ''; ?>" data-option="1-2">1-2</a>
                        <a data-attr="bedrooms" href="<?php echo esc_url(home_url('/')); ?>?s=<?php echo $s ?>&property_type=<?php echo $property_type; ?>&bedrooms=3-4<?php echo $more_properties; ?>" class="filter-button bedr <?php echo $bedrooms == '3-4' ? 'active' : ''; ?>" data-option="3-4">3-4</a>
                        <a data-attr="bedrooms" href="<?php echo esc_url(home_url('/')); ?>?s=<?php echo $s ?>&property_type=<?php echo $property_type; ?>&bedrooms=5<?php echo $more_properties; ?>" class="filter-button bedr <?php echo $bedrooms == '5' ? 'active' : ''; ?>" data-option="5+">5+</a>
                    <?php else: ?>
                        <a data-attr="bedrooms" href="<?php echo esc_url(home_url('/')); ?>?s=<?php echo $s ?>&bedrooms=1-2<?php echo $more_properties; ?>" class="filter-button bedr <?php echo $bedrooms == '1-2' ? 'active' : ''; ?>" data-option="1-2">1-2</a>
                        <a data-attr="bedrooms" href="<?php echo esc_url(home_url('/')); ?>?s=<?php echo $s ?>&bedrooms=3-4<?php echo $more_properties; ?>" class="filter-button bedr <?php echo $bedrooms == '3-4' ? 'active' : ''; ?>" data-option="3-4">3-4</a>
                        <a data-attr="bedrooms" href="<?php echo esc_url(home_url('/')); ?>?s=<?php echo $s ?>&bedrooms=5<?php echo $more_properties; ?>" class="filter-button bedr <?php echo $bedrooms == '5' ? 'active' : ''; ?>" data-option="5+">5+</a>
                    <?php endif; ?>
                </div>
            </div>
        ...
        <div class="for_sale-list" data-bedrooms="" data-property-type="">
            <h2>Related Properties<span>.</span></h2>
            <?php get_properties_grid($currentPage, $s, $show, $bedrooms, $property_type, $availability,0,$type); ?>
        </div>
    </div>
</section>
...
<section class="register">
    ...
    <div class="container">
        <div class="register_box">
            <h2>Register with Laurels to have exclusive access to our off market properties.</h2>
            <a href="<?php echo esc_url(home_url('get-in-touch')) ?>?offmarket">Register Here</a>
        </div>
    </div>
</section>
